...
`,Or="__vaadin-theme-editor-measure-element",zr=/((::before)|(::after))$/,Lr=/::part\(([\w\d_-]+)\)$/;Uo(b`
...
`);async function Is(t){const e=new ce(t),o=document.createElement(t.tagName);o.classList.add(Or),document.body.append(o),t.setupElement&&await t.setupElement(o);const r={themeScope:D.local,localClassName:Or};try{t.elements.forEach(i=>{Mr(o,i,r,!0);let n=Me(i,r);const s=n.match(zr);n=n.replace(zr,"");const l=n.match(Lr),a=n.replace(Lr,"");let d=document.querySelector(a);if(d&&l){const h=`[part~="${l[1]}"]`;d=d.shadowRoot.querySelector(h)}if(!d)return;d.style.transition="none";const c=s?s[1]:null,m=getComputedStyle(d,c);i.properties.forEach(h=>{const g=m.getPropertyValue(h.propertyName)||h.defaultValue||"";e.updatePropertyValue(i.selector,h.propertyName,g)}),Mr(o,i,r,!1)})}finally{try{t.cleanupElement&&await t.cleanupElement(o)}finally{o.remove()}}return e}function Mr(t,e,o,r){if(e.stateAttribute){if(e.stateElementSelector){const i=Me({...e,selector:e.stateElementSelector},o);t=document.querySelector(i)}t&&(r?t.setAttribute(e.stateAttribute,""):t.removeAttribute(e.stateAttribute))}}function Vr(t){return t.trim()}function Rs(t){const e=t.element;if(!e)return null;const o=e.querySelector("label");if(o&&o.textContent)return Vr(o.textContent);const r=e.textContent;return r?Vr(r):null}class Os{constructor(){this._localClassNameMap=new Map}get stylesheet(){return this.ensureStylesheet(),this._stylesheet}add(e){this.ensureStylesheet(),this._stylesheet.replaceSync(e)}clear(){this.ensureStylesheet(),this._stylesheet.replaceSync("")}previewLocalClassName(e,o){if(!e)return;const r=this._localClassNameMap.get(e);r&&(e.classList.remove(r),e.overlayClass=null),o?(e.classList.add(o),e.overlayClass=o,this._localClassNameMap.set(e,o)):this._localClassNameMap.delete(e)}ensureStylesheet(){this._stylesheet||(this._stylesheet=new CSSStyleSheet,this._stylesheet.replaceSync(""),document.adoptedStyleSheets=[...document.adoptedStyleSheets,this._stylesheet])}}const fe=new Os;class zs{constructor(e){this.pendingRequests={},this.requestCounter=0,this.globalUiId=this.getGlobalUiId(),this.wrappedConnection=e;const o=this.wrappedConnection.onMessage;this.wrappedConnection.onMessage=r=>{r.command==="themeEditorResponse"?this.handleResponse(r.data):o.call(this.wrappedConnection,r)}}sendRequest(e,o){const r=(this.requestCounter++).toString(),i=o.uiId??this.globalUiId;return new Promise((n,s)=>{this.wrappedConnection.send(e,{...o,requestId:r,uiId:i}),this.pendingRequests[r]={resolve:n,reject:s}})}handleResponse(e){const o=this.pendingRequests[e.requestId];if(!o){console.warn("Received response for unknown request");return}delete this.pendingRequests[e.requestId],e.code==="ok"?o.resolve(e):o.reject(e)}loadComponentMetadata(e){return this.sendRequest("themeEditorComponentMetadata",{nodeId:e.nodeId})}setLocalClassName(e,o){return this.sendRequest("themeEditorLocalClassName",{nodeId:e.nodeId,className:o})}setCssRules(e){return this.sendRequest("themeEditorRules",{rules:e})}loadRules(e){return this.sendRequest("themeEditorLoadRules",{selectors:e})}markAsUsed(){return this.sendRequest("themeEditorMarkAsUsed",{})}undo(e){return this.sendRequest("themeEditorHistory",{undo:e})}redo(e){return this.sendRequest("themeEditorHistory",{redo:e})}openCss(e){return this.sendRequest("themeEditorOpenCss",{selector:e})}getGlobalUiId(){const e=window.Vaadin;if(e&&e.Flow){const{clients:o}=e.Flow,r=Object.keys(o);for(const i of r){const n=o[i];if(n.getNodeId)return n.getUIId()}}return-1}}const O={index:-1,entries:[]};class Ls{constructor(e){this.api=e}get allowUndo(){return O.index>=0}get allowRedo(){return O.index<O.entries.length-1}get allowedActions(){return{allowUndo:this.allowUndo,allowRedo:this.allowRedo}}push(e,o,r){const i={requestId:e,execute:o,rollback:r};if(O.index++,O.entries=O.entries.slice(0,O.index),O.entries.push(i),o)try{o()}catch(n){console.error("Execute history entry failed",n)}return this.allowedActions}async undo(){if(!this.allowUndo)return this.allowedActions;const e=O.entries[O.index];O.index--;try{await this.api.undo(e.requestId),e.rollback&&e.rollback()}catch(o){console.error("Undo failed",o)}return this.allowedActions}async redo(){if(!this.allowRedo)return this.allowedActions;O.index++;const e=O.entries[O.index];try{await this.api.redo(e.requestId),e.execute&&e.execute()}catch(o){console.error("Redo failed",o)}return this.allowedActions}static clear(){O.entries=[],O.index=-1}}var Ms=Object.defineProperty,Vs=Object.getOwnPropertyDescriptor,ue=(t,e,o,r)=>{for(var i=r>1?void 0:r?Vs(e,o):e,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=(r?s(e,o,i):s(i))||i);return r&&i&&Ms(e,o,i),i};class Ds extends CustomEvent{constructor(e,o,r){super("theme-property-value-change",{bubbles:!0,composed:!0,detail:{element:e,property:o,value:r}})}}class W extends A{constructor(){super(...arguments),this.value=""}static get styles(){return[wi,b`
    ...
    </div>`}handleInputChange(t){this.editedClassName=t.detail.value;const e=/^-?[_a-zA-Z]+[_a-zA-Z0-9-]*$/;this.invalid=!this.editedClassName.match(e),!this.invalid&&this.editedClassName!==this.className&&this.dispatchEvent(new Fs(this.editedClassName))}};jt([y({})],Ze.prototype,"className",2);jt([T()],Ze.prototype,"editedClassName",2);jt([T()],Ze.prototype,"invalid",2);Ze=jt([F("vaadin-dev-tools-theme-class-name-editor")],Ze);var Bs=Object.defineProperty,Hs=Object.getOwnPropertyDescriptor,Ft=(t,e,o,r)=>{for(var i=r>1?void 0:r?Hs(e,o):e,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=(r?s(e,o,i):s(i))||i);return r&&i&&Bs(e,o,i),i};class Ws extends CustomEvent{constructor(e){super("scope-change",{detail:{value:e}})}}Uo(b`
...
`);let et=class extends A{constructor(){super(...arguments),this.value=D.local}static get styles(){return b`
      vaadin-select {
        --lumo-primary-color-50pct: rgba(255, 255, 255, 0.5);
        width: 100px;
      }
    ...
    ></vaadin-select>`}selectRenderer(t){var e;const o=((e=this.metadata)==null?void 0:e.displayName)||"Component",r=`${o}s`;Re(f`
      ...
      `,t)}handleValueChange(t){const e=t.detail.value;e!==this.value&&this.dispatchEvent(new Ws(e))}};Ft([y({})],et.prototype,"value",2);Ft([y({})],et.prototype,"metadata",2);Ft([it("vaadin-select")],et.prototype,"select",2);et=Ft([F("vaadin-dev-tools-theme-scope-selector")],et);var qs=Object.defineProperty,Gs=Object.getOwnPropertyDescriptor,Ks=(t,e,o,r)=>{for(var i=r>1?void 0:r?Gs(e,o):e,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=(r?s(e,o,i):s(i))||i);return r&&i&&qs(e,o,i),i};let Ur=class extends W{static get styles(){return[W.styles,b`
        .editor-row {
          align-items: center;
        }
      ...
      <vaadin-dev-tools-theme-text-input
        ...
        @change=${this.handleInputChange}
      ></vaadin-dev-tools-theme-text-input>
    `}};jr=Xs([F("vaadin-dev-tools-theme-text-property-editor")],jr);var Qs=Object.defineProperty,Zs=Object.getOwnPropertyDescriptor,jo=(t,e,o,r)=>{for(var i=r>1?void 0:r?Zs(e,o):e,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=(r?s(e,o,i):s(i))||i);return r&&i&&Qs(e,o,i),i};let Rt=class extends W{constructor(){super(...arguments),this.selectedPresetIndex=-1,this.presets=new At}static get styles(){return[W.styles,b`
        :host {
          --preset-count: 3;
          --slider-bg: #fff;
          --slider-border: #333;
...
`;let tt=class extends A{constructor(){super(...arguments),this.commitValue=!1}static get styles(){return[Ei,b`
        #toggle {
          display: block;
        }
    ...
    ></button>`}open(){this.commitValue=!1,this.overlay.opened=!0,this.overlay.style.zIndex="1000000";const t=this.overlay.shadowRoot.querySelector('[part="overlay"]');t.style.background="#333"}renderOverlayContent(t){const e=getComputedStyle(this.toggle,"::after").getPropertyValue("background-color");Re(f` <div>
        ...
        ></vaadin-dev-tools-color-picker-overlay-content>
      </div>`,t)}handleColorChange(t){this.commitValue=!0,this.dispatchEvent(new Sa(t.detail.value)),t.detail.close&&(this.overlay.opened=!1,this.handleOverlayClose())}handleOverlayEscape(){this.commitValue=!1}handleOverlayClose(){const t=this.commitValue?"color-picker-commit":"color-picker-cancel";this.dispatchEvent(new CustomEvent(t))}};Se([y({})],tt.prototype,"value",2);Se([y({})],tt.prototype,"presets",2);Se([it("#toggle")],tt.prototype,"toggle",2);tt=Se([F("vaadin-dev-tools-color-picker")],tt);let Lt=class extends A{static get styles(){return[Ei,b`
        :host {
          display: block;
          padding: 12px;
        }
    ...
    `}handleOpenCss(t){this.dispatchEvent(new Na(t))}renderPropertyEditor(t,e){let o;switch(e.editorType){case P.checkbox:o=pt`vaadin-dev-tools-theme-checkbox-property-editor`;break;case P.range:o=pt`vaadin-dev-tools-theme-range-property-editor`;break;case P.color:o=pt`vaadin-dev-tools-theme-color-property-editor`;break;default:o=pt`vaadin-dev-tools-theme-text-property-editor`}return gs` <${o}
    ...
    `];Vt=Ia([F("vaadin-dev-tools-shim")],Vt);const Ci=b`
  .popup {
    width: auto;
    position: fixed;
...
`;var Ra=Object.defineProperty,Oa=Object.getOwnPropertyDescriptor,nt=(t,e,o,r)=>{for(var i=r>1?void 0:r?Oa(e,o):e,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=(r?s(e,o,i):s(i))||i);return r&&i&&Ra(e,o,i),i};let he=class extends A{constructor(){super(...arguments),this.active=!1,this.components=[],this.selected=0}connectedCallback(){super.connectedCallback();const t=new CSSStyleSheet;t.replaceSync(`
    ...
    `];nt([T()],he.prototype,"active",2);nt([T()],he.prototype,"components",2);nt([T()],he.prototype,"selected",2);nt([it("vaadin-dev-tools-shim")],he.prototype,"shim",2);he=nt([F("vaadin-dev-tools-component-picker")],he);const za=Object.freeze(Object.defineProperty({__proto__:null,get ComponentPicker(){return he}},Symbol.toStringTag,{value:"Module"}));var La=Object.defineProperty,Ma=Object.getOwnPropertyDescriptor,pe=(t,e,o,r)=>{for(var i=r>1?void 0:r?Ma(e,o):e,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=(r?s(e,o,i):s(i))||i);return r&&i&&La(e,o,i),i};Uo(b`
  .vaadin-theme-editor-highlight {
    outline: solid 2px #9e2cc6;
    outline-offset: 3px;
  }
`);let ie=class extends A{constructor(){super(...arguments),this.expanded=!1,this.themeEditorState=Qe.enabled,this.context=null,this.baseTheme=null,this.editedTheme=null,this.effectiveTheme=null}static get styles(){return b`
      :host {
...
`),e.content.appendChild(o)}function ll(t){const e=`${t}-default-theme`,o=Ao().filter(r=>r.moduleId!==e&&nl(r.themeFor,t)).map(r=>({...r,styles:[...Ai(r),...r.styles],includePriority:sl(r.moduleId)})).sort((r,i)=>i.includePriority-r.includePriority);return o.length>0?o:Ao().filter(r=>r.moduleId===e)}const Pl=t=>class extends ol(t){static finalize(){if(super.finalize(),this.elementStyles)return;const o=this.prototype._template;!o||Pi(this)||al(this.getStylesForThis(),o)}static finalizeStyles(o){const r=this.getStylesForThis();return o?[...super.finalizeStyles(o),...r]:r}static getStylesForThis(){const o=Object.getPrototypeOf(this.prototype),r=(o?o.constructor.__themes:[])||[];this.__themes=[...r,...ll(this.is)];const i=this.__themes.flatMap(n=>n.styles);return i.filter((n,s)=>s===i.lastIndexOf(n))}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const dl=(t,...e)=>{const o=document.createElement("style");o.id=t,o.textContent=e.map(r=>r.toString()).join(`
`).replace(":host","html"),document.head.insertAdjacentElement("afterbegin",o)},cl=b`[part=input-field]{box-shadow:inset 0 0 0 1px var(--lumo-contrast-30pct);background-color:var(--lumo-base-color)}:host([focus-ring]) [part=input-field]{box-shadow:0 0 0 2px var(--lumo-primary-color-50pct),inset 0 0 0 1px var(--lumo-primary-color)}:host([invalid]) [part=input-field]{box-shadow:inset 0 0 0 1px var(--lumo-error-color)}
`,hl=b`[part=input-field]{box-shadow:inset 0 0 0 1px var(--lumo-contrast-30pct);background-color:var(--lumo-base-color)}:host([focus-ring]) [part=input-field]{box-shadow:0 0 0 2px var(--lumo-primary-color-50pct),inset 0 0 0 1px var(--lumo-primary-color)}:host([invalid]) [part=input-field]{box-shadow:inset 0 0 0 1px var(--lumo-error-color)}
`,ul=b`[part=input-field]{box-shadow:inset 0 0 0 1px var(--lumo-contrast-30pct);background-color:var(--lumo-base-color)}:host([focus-ring]) [part=input-field]{box-shadow:0 0 0 2px var(--lumo-primary-color-50pct),inset 0 0 0 1px var(--lumo-primary-color)}:host([invalid]) [part=input-field]{box-shadow:inset 0 0 0 1px var(--lumo-error-color)}
`;document._vaadintheme_myapp_componentCss||(ye("vaadin-password-field",xt(cl.toString())),ye("vaadin-text-area",xt(hl.toString())),ye("vaadin-text-field",xt(ul.toString())),document._vaadintheme_myapp_componentCss=!0);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class pl extends HTMLElement{static get version(){return"24.1.1"}}customElements.define("vaadin-lumo-styles",pl);const me=(t,...e)=>{dl(`lumo-${t}`,e)};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ml=b`
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */me("utility",Jo);const kl=t=>{const e=[];t!==document&&(e.push(Be(Go.cssText,"",t,!0)),e.push(Be(Ko.cssText,"",t,!0)),e.push(Be(Ii.cssText,"",t,!0)),e.push(Be(Yo.cssText,"",t,!0)),e.push(Be(Jo.cssText,"",t,!0)))},$l=kl;$l(document);export{ss as D,He as F,A as L,is as P,Pl as T,Ae as U,E as _,me as a,we as b,b as c,ns as d,ye as e,ol as f,Ko as g,f as h,Go as i,J as j,Ss as k,Es as l,k as n,Re as r,Pe as s,Ni as t,xt as u,P as y};
